...
-- 10 складов (привязываем к городам по названиям)
INSERT INTO warehouse (warehouse_name, city_id, address) VALUES
('Склад Центральный', (SELECT city_id FROM city WHERE city_name = 'Москва'), 'ул. Ленина, д. 1'),
('Склад Северный', (SELECT city_id FROM city WHERE city_name = 'Санкт-Петербург'), 'пр. Невский, д. 25'),
('Склад Восточный', (SELECT city_id FROM city WHERE city_name = 'Новосибирск'), 'ул. Красный проспект, д. 10'),
('Склад Западный', (SELECT city_id FROM city WHERE city_name = 'Екатеринбург'), 'ул. Ленина, д. 50'),
('Склад Южный', (SELECT city_id FROM city WHERE city_name = 'Казань'), 'ул. Баумана, д. 15'),
('Склад Промышленный', (SELECT city_id FROM city WHERE city_name = 'Нижний Новгород'), 'ул. Покровка, д. 8'),
('Склад Торговый', (SELECT city_id FROM city WHERE city_name = 'Челябинск'), 'ул. Кирова, д. 30'),
('Склад Логистический', (SELECT city_id FROM city WHERE city_name = 'Самара'), 'ул. Московское шоссе, д. 5'),
('Склад Распределительный', (SELECT city_id FROM city WHERE city_name = 'Омск'), 'ул. Ленина, д. 100'),
('Склад Региональный', (SELECT city_id FROM city WHERE city_name = 'Ростов-на-Дону'), 'пр. Буденновский, д. 20')
ON CONFLICT (warehouse_name, city_id) DO NOTHING;

-- 20 маршрутов между городами (используем подзапросы для получения city_id по названиям)
-- Важно: city_a_id должен быть меньше city_b_id для соблюдения ограничения
INSERT INTO city_route (city_a_id, city_b_id, distance_km) 
SELECT 
    LEAST(c1.city_id, c2.city_id) as city_a_id,
    GREATEST(c1.city_id, c2.city_id) as city_b_id,
    distance
FROM (VALUES
    ('Москва', 'Санкт-Петербург', 635.0),
    ('Москва', 'Новосибирск', 2810.0),
    ('Москва', 'Екатеринбург', 1417.0),
    ('Москва', 'Казань', 815.0),
    ('Москва', 'Нижний Новгород', 411.0),
    ('Санкт-Петербург', 'Новосибирск', 3445.0),
    ('Санкт-Петербург', 'Екатеринбург', 1832.0),
    ('Санкт-Петербург', 'Казань', 1445.0),
    ('Новосибирск', 'Екатеринбург', 1393.0),
    ('Новосибирск', 'Казань', 1995.0),
    ('Новосибирск', 'Нижний Новгород', 2399.0),
    ('Екатеринбург', 'Казань', 602.0),
    ('Екатеринбург', 'Нижний Новгород', 1006.0),
    ('Екатеринбург', 'Челябинск', 200.0),
    ('Казань', 'Нижний Новгород', 404.0),
    ('Казань', 'Челябинск', 802.0),
    ('Нижний Новгород', 'Челябинск', 1206.0),
    ('Челябинск', 'Самара', 1200.0),
    ('Самара', 'Омск', 1500.0),
    ('Омск', 'Ростов-на-Дону', 2100.0)
) AS routes(city_a_name, city_b_name, distance)
JOIN city c1 ON c1.city_name = routes.city_a_name
JOIN city c2 ON c2.city_name = routes.city_b_name
WHERE LEAST(c1.city_id, c2.city_id) < GREATEST(c1.city_id, c2.city_id)
